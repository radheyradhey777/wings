...
type DockerNetworkConfiguration struct {
	...
	// defined.
	Name       string                  `default:"coramtix_nw"`
	ISPN       bool                    `default:"false" yaml:"ispn"`
	IPv6       bool                    `default:"true" yaml:"IPv6"`
	Driver     string                  `default:"bridge"`
	Mode       string                  `default:"coramtix_nw" yaml:"network_mode"`
...
type DockerConfiguration struct {
	...
	// if the value is "host", then the coramtix containers are started with user namespace
	// remapping disabled
